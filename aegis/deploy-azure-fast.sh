...
# Azure deployment script for AEGIS Security Backend (Optimized)
# Southeast Asia deployment with pre-built JAR
...
echo "🚀 Starting AEGIS Security Backend deployment to Azure Southeast Asia (Optimized)..."
...
# Temporarily rename dockerignore files
